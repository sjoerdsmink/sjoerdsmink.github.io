jQuery( function($){
	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/slider1.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Herinnering</h2><p>Automatische melding bij een vergeten check-out</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider2.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Be-In Be-Out</h2><p>Nooit meer in- en uitchecken</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider3.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Be-In Be-Out</h2><p>Nooit meer in- en uitchecken</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider4.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Be-In Be-Out</h2><p>Nooit meer in- en uitchecken</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider5.jpg', title : '<div class="hero-text"><h2 class="hero-heading">Be-In Be-Out</h2><p>Nooit meer in- en uitchecken</p></div>', thumb : '', url : ''}    
						],
		});
	...
	*/
	...
	$('#downloadMailForm').parsley();

	$('#downloadMailForm').submit( function(e) {
		...
		$btn.prop('disabled', true).find('span').text("Versturen...");

		$.post('downloadMail.php', $(this).serialize(), function(data){
